...
% output layout (no per-site subfolder) used by Step1_SumPPICIBin_createWorkspace_AZORES.m
...
dataDir = 'F:\AZORES\SeasonalityAnalysis'; % everything lives under F:\AZORES (matches Step1_SumPPICIBin_createWorkspace_AZORES.m)
...
%Sites to process - must match siteabrev used in Step1_SumPPICIBin_createWorkspace_AZORES.m
...
fprintf('\n=== Processing %s ===\n',siteabrev)
saveDir = 'F:\AZORES\SeasonalityAnalysis';
%% load workspace
load(fullfile(saveDir,['\',siteabrev,'\',siteabrev,'_workspace125.mat']));
