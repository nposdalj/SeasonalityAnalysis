...
% AZORES version - single site per run (edit siteName and rerun for the other AZORES site).
% Matches the flat F:\AZORES\SeasonalityAnalysis\<siteName>\ layout used by the AZORES Step2/Step3 scripts.
%% load data
siteName = 'AZORES_A_04_DEEP'; % or 'AZORES_A_04_DEEP'
NumBub = 3;
DataDir = ['F:\AZORES\SeasonalityAnalysis\',siteName];
saveDirectory = DataDir; %plots are saved alongside the site's data - no separate Plots tree for AZORES
