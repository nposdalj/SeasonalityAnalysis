...
if (site == 'CB' & sex == 'Social Groups' | site == 'GOA' & sex == 'Mid-Size'){
  ggPlot_JD_AfterYear(PODFinal, SiteHourTableB,sex,COL)
}else if (site == 'GOA' & sex == 'Males'){
  ggPlot_JD_AfterSite(PODFinal, SiteHourTableB,sex,COL)
}else if (site == 'Big'){
  ggPlot_JD_AfterYearB(PODFinal, SiteHourTableB,sex,COL)
}else if (site == 'GOA' & sex == 'Social Groups'){
  ggPlot_JD_AfterYearSite(PODFinal,SiteHourTableB,sex,COL)
}else{
