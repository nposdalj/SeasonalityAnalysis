...
#bs(Julian, k = 4)     2665  4     <2e-16 ***
#as.factor(Year)       1595  4     <2e-16 ***
#as.factor(Region)    46065  1     <2e-16 ***
#TimeLost               325  1     <2e-16 ***
...
VIF(GLM1)
#bs(Julian)        1.35  3            1.05
#TimeLost          1.01  1            1.00
#as.factor(Year)   1.36  4            1.04
#as.factor(Region) 1.04  1            1.02
...
#QIC3AA   341858.063547072 301094.416951758 306351.290549769 303394.839128275 335996.278717247
#Full model is best
#Model order - Region, Julian Day, Year

# Step 7: Finalize Model --------------------------------------------------
dimnames(AvgDayMat)<-list(NULL,c("ADBM1", "ADBM2"))
PODFinal = geeglm(PreAbs ~ as.factor(Region)+AvgDayMat+as.factor(Year),family = binomial, corstr="ar1", id=Blocks, data=SiteHourTableB)
...
anova(PODFinal)
#as.factor(Region)  1 13262    <2e-16 ***
#AvgDayMat          2   949    <2e-16 ***
#as.factor(Year)    4   623    <2e-16 ***
