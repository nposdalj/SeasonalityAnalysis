...
ggPlot_JD_SG_WATBIG <- function(model, table,site,sex){
  BootstrapParameters3<-rmvnorm(10000, coef(model),summary(model)$cov.unscaled)
...
ggPlot_JD_Last <- function(model,table,site,sex){
  BootstrapParameters3<-rmvnorm(10000, coef(model),summary(model)$cov.unscaled)
...
ggPlot_JD_AfterSite <- function(model,table,site,sex){
  BootstrapParameters3<-rmvnorm(10000, coef(model),summary(model)$cov.unscaled)
...
ggPlot_Site_WAT <- function(model,table,site,sex){
  BootstrapParameters2<-rmvnorm(10000, coef(model),summary(model)$cov.unscaled)
...
ggPlot_Site_WATT <- function(model,table,site,sex){
  BootstrapParameters2<-rmvnorm(10000, coef(model),summary(model)$cov.unscaled)
  start=2; end=5; Variable=table$Site
  BootstrapCoefs2<-BootstrapParameters2[, c(1,start:end)]
...
ggPlot_Site_WATTT <- function(model,table,site,sex){
  BootstrapParameters2<-rmvnorm(10000, coef(model),summary(model)$cov.unscaled)
...
ggPlot_Year_WAT_regional <- function(model, table,site,sex){
  BootstrapParameters2<-rmvnorm(10000, coef(model),summary(model)$cov.unscaled)
  ...
  ggtitle = paste(saveDir,"/Year - ",sex,'_', site,".pdf",sep="")
...
ggPlot_Year_WATTT_north <- function(model, table,site){
  BootstrapParameters2<-rmvnorm(10000, coef(model),summary(model)$cov.unscaled)
...
ggPlot_Year_WATT_north <- function(model, table,site){
  BootstrapParameters2<-rmvnorm(10000, coef(model),summary(model)$cov.unscaled)
...
#Year is first term for Big Model
ggPlot_Year_WATT_Big <- function(model, table,site){
  BootstrapParameters2<-rmvnorm(10000, coef(model),summary(model)$cov.unscaled)
...
#Year is first term for Big Model
ggPlot_Year_WATTT_Big <- function(model, table,site){
  BootstrapParameters2<-rmvnorm(10000, coef(model),summary(model)$cov.unscaled)
