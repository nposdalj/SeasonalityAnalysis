...
site = 'QN' #specify the site of interest
...
#PT
# bs(Julian, k = 4)   410.06  4     <2e-16 ***
#   TimeLost              1.82  1     0.1776 

#QN
# bs(Julian, k = 4)   88.721  4    < 2e-16 ***
#   TimeLost             3.749  1    0.05284 . 
...
Anova(BlockModJ)
#BD
# bs(Julian, k = 4)      316  4     <2e-16 ***
#   TimeLost                 1  1       0.45  

#PT
# bs(Julian, k = 4)  315.240  4     <2e-16 ***
#   TimeLost             0.663  1     0.4154 
#QN
# bs(Julian, k = 4)   149.00  4     <2e-16 ***
#   TimeLost              0.05  1     0.8238
...
#TimeLost       0.07  1     0.81

#PT
# bs(Julian, k = 4)   79.521  4     <2e-16 ***
#   TimeLost             0.063  1     0.8019  

#QN
# bs(Julian, k = 4)  231.952  4     <2e-16 ***
#   TimeLost             1.973  1     0.1601   
...
# QIC0fA   3338.73672187656 2366.09602016 2370.81478809115
#Julian day as a covariance matrix.

#PT
#QIC            QIC.1            QIC.2
#model0fA            POD0f           POD0fa           POD0fb
# QIC0fA   3005.53153922808 2795.29540614838 2789.96288238269
#Julian day as a covariance matrix

#QN
#QIC            QIC.1            QIC.2
#model0fA            POD0f           POD0fa           POD0fb
# QIC0fA   2372.04767788591 2350.06740736259 2343.55687051253
#Julian day as a covariance matrix

#CB
#QIC            QIC.1            QIC.2
# model0fA            POD0f           POD0fa           POD0fb
# QIC0fA   2329.98680269474 2323.69023489873 2324.67646826925
#Julian day as a covariance matrix
...
# QIC1fA   2329.98680269474 2155.65331278052 2302.74218858981 2167.01345487412
...
# QIC2fA   3338.73672187656 3369.01080243045 3338.72774893674 24346.2907153603
#TimeLost as linear.
...
# QIC0jA   13024.1986792464 12758.4229776906 12756.3828384462
#Julian day as covariance matrix

#PT
#QIC            QIC.1            QIC.2
#model0jA            POD0j           POD0ja           POD0jb
# QIC0jA   6351.80655303413 6081.37380725231 6080.36658498164
#Julian day as covariance matrix

#QN
#QIC            QIC.1            QIC.2
#model0jA            POD0j           POD0ja           POD0jb
# QIC0jA   5202.30044371518 5093.35386437756 5090.13166270931
#Julian day as a covariance matrix

#CB                      QIC            QIC.1            QIC.2
# QIC            QIC.1            QIC.2
# model0jA            POD0j           POD0ja           POD0jb
# QIC0jA   46282.9243919683 44412.8330708007 44459.9491553825
#Julian day as a covariance matrix
...
# QIC1jA   46282.9243919683 45352.2087787943 46188.4957092451 45725.6312287581
#Year as mSpline
...
# QIC2jA   13024.1986792464 156691.918352022 13042.6926255444 13070.1825432952
#TimeLost as linear.
...
#QIC            QIC.1            QIC.2            QIC.3
#model2jA            POD0j           POD2ja           POD2jb           POD2jc
# QIC2jA   5202.30044371518 47319.1453254841 5205.47424038469 5202.56194580014
#TimeLost as linear.
...
# QIC0mA   14923.6298475946 14712.2429921342 14711.7058565453
#Julian Day as covariance matrix

#PT
#QIC            QIC.1            QIC.2
#model0mA            POD0m           POD0ma           POD0mb
# QIC0mA   3067.23236783793 3009.57740141382 3004.5604735452
#Julian Day as covariance matrix

#QN
#QIC            QIC.1           QIC.2
#model0mA            POD0m           POD0ma          POD0mb
#QIC0mA   5792.29126237159 5562.92196441717 5565.70113021508
#Julian Day as covariance matrix

#CB
# QIC            QIC.1            QIC.2
# model0mA            POD0m           POD0ma           POD0mb
# QIC0mA   40423.1848466578 39368.9692768209 39377.2302974979
#Julian Day as covariance matrix
...
# QIC1mA   40423.1848466578 39577.9993036564 40403.6768247888 39649.5820154624
#Year as an mSpline
...
# QIC2mA   14923.6298475946 14967.2969922913 14934.2052465255 14943.8998796069
#TimeLost as linear.

#PT
#QIC            QIC.1            QIC.2            QIC.3
#model2mA            POD0m           POD2ma           POD2mb           POD2mc
# QIC2mA   3067.23236783793 22835.5609703616 3073.06311894563 22983.2502422863
#TimeLost as linear.

#QN
#QIC            QIC.1            QIC.2            QIC.3
#model2mA            POD0m           POD2ma           POD2mb           POD2mc
#QIC2mA   5792.29126237159 5978.32840011565 5844.65460087863 50736.0793039476
#TimeLost as linear.
...
# QIC3fA   2329.98680269474 2135.47935331099 2174.60945093025 2332.22292946268 2124.3029368653
#Remove TimeLost.
...
# QIC3fB   2329.98680269474 2124.3029368653 2167.01345487412 2324.67646826925
...
#Year is first.
  ...
  # QIC            QIC.1            QIC.2            QIC.3
  # model3fA            POD0f           POD3fa           POD3fb           POD3fc
  #QIC3fA   3005.53153922808 22422.5522520506 22421.2152203148 2789.96288238269
  #Remove Time Lost.
  
  #QN
  #QIC            QIC.1            QIC.2            QIC.3
  #model3fA            POD0f           POD3fa           POD3fb           POD3fc
  #QIC3fA   2372.04767788591 2343.07132169012 2370.72248860827 2343.55687051253
  #Remove Time Lost.
...
# QIC3jA   46282.9243919683 44242.319682631 45748.7088099909 44476.0038559734 44226.6236836243
#Remove TimeLost
...
# QIC3jB   46282.9243919683 44226.6236836243 45725.6312287581 44459.9491553825
#Full model is the best.
#AvgDayMat first in model.
  ...
  # QIC3jA   13024.1986792464 12772.0094827081 13042.6926255444 12756.3828384462
  #Remove TimeLost
  
  #PT
  # QIC            QIC.1            QIC.2            QIC.3
  # model3jA            POD0j           POD3ja           POD3jb           POD3jc
  # QIC3jA   6351.80655303413 6085.46767424176 6358.76854561236 6080.36658498164
  #Remove TimeLost.
  
  #QN
  #QIC            QIC.1            QIC.2            QIC.3
  #model3jA            POD0j           POD3ja           POD3jb           POD3jc
  #QIC3jA   5202.30044371518 5092.74773075466 5205.47424038469 5090.13166270931
  #Remvoe Time Lost.
}
...
# QIC3mA   40423.1848466578 38784.2474259187 39672.2955727318 39387.5227351634 38775.8310029158
#Remove TimeLost.
...
#QIC3mB   40423.1848466578 38775.8310029158 39649.5820154624 39377.2302974979
#Full model is the best.
#AvgDayMat first, then year.
  ...
  # QIC3mA   14923.6298475946 14721.7135733651 14934.2052465255 14711.7058565453
  #Remove Timelost.
  
  #PT
  # QIC            QIC.1            QIC.2           QIC.3
  # model3mA            POD0m           POD3ma           POD3mb          POD3mc
  # QIC3mA   3067.23236783793 3009.86500790704 3073.06311894563 3004.5604735452
  #Remove Time Lost.
  
  #QN
  #QIC            QIC.1            QIC.2            QIC.3
  #model3mA            POD0m           POD3ma           POD3mb           POD3mc
  #QIC3mA   5792.29126237159 5573.29238688752 5844.65460087863 5565.70113021508
  #Remove Time Lost.
}
...
#BD
# Df   X2 P(>|Chi|)  
# AvgDayMatF  2 5.02     0.081 .
#PT
# AvgDayMatF  2 14.004 0.0009101 ***
  #QN
#AvgDayMatF  4 15.3     0.004 **
#CB
# mSpline(Year, knots = quantile(Year, probs = c(0.333, 0.666)), Boundary.knots = c(2011, 2019))  5 16.8081  0.004879 **
#   AvgDayMatF                                                                                      2  4.8644  0.087845 . 
#QN
#Df     X2 P(>|Chi|)
#AvgDayMatF  2 2.7009    0.2591

anova(PODFinalJ)
#BD
# Df   X2 P(>|Chi|)   
# AvgDayMatJ  2 9.79    0.0075 **
#PT
# Df     X2 P(>|Chi|)    
# AvgDayMatJ  2 18.558 9.339e-05 ***
  #QN
#AvgDayMatJ  4 25.6   3.8e-05 ***
#CB
# AvgDayMatJ                                                                                      2 21.9018 1.754e-05 ***
#   mSpline(Year, knots = quantile(Year, probs = c(0.333, 0.666)), Boundary.knots = c(2011, 2019))  5  4.9162    0.4262   
#QN
...
#BD
# Df   X2 P(>|Chi|)    
# AvgDayMatM  2 17.6   0.00015 ***
#PT
# AvgDayMatM  2 4.3566    0.1132
#QN
#AvgDayMatM  4 10      0.04 *
#CB
# AvgDayMatM                                                                                      2 18.311 0.0001056 ***
#   mSpline(Year, knots = quantile(Year, probs = c(0.333, 0.666)), Boundary.knots = c(2011, 2019))  5 17.112 0.0042924 ** 
#QN
#AvgDayMatM  2 6.183   0.04543 *
