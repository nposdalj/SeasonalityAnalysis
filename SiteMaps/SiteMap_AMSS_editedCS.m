...
ALEUTBD_latLongs = [52.633333,-175.63; %BD02
52.076,-175.64]; %BD03
...
text(latitude(1),longitude(1)-0.5,'AB','HorizontalAlignment','right','FontSize',14);
text(latitude(2)+0.75,longitude(2),'BD','HorizontalAlignment','right','FontSize',14);
text(latitude(3),longitude(3)-0.5,'CB','HorizontalAlignment','right','FontSize',14);
text(latitude(4)+.4,longitude(4)-0.5,'KS','HorizontalAlignment','right','FontSize',14);
text(latitude(5),longitude(5)+2.5,'PT','HorizontalAlignment','right','FontSize',14);
text(latitude(6),longitude(6)-0.75,'QN','HorizontalAlignment','right','FontSize',14);
text(latitude(7),longitude(7)-0.75,'KOA','HorizontalAlignment','right','FontSize',14);
%% grey site map
figure(2)
LatLongTAB.Site = categorical(LatLongTAB.Site);
A = 200;
...
text(latitude(1),longitude(1)-0.5,'AB','HorizontalAlignment','right','FontSize',15);
text(latitude(2)+0.75,longitude(2),'BD','HorizontalAlignment','right','FontSize',15);
text(latitude(3),longitude(3)-0.5,'CB','HorizontalAlignment','right','FontSize',15);
text(latitude(4)+.4,longitude(4)-0.5,'KS','HorizontalAlignment','right','FontSize',15);
text(latitude(5),longitude(5)+2.5,'PT','HorizontalAlignment','right','FontSize',15);
text(latitude(6),longitude(6)-0.75,'QN','HorizontalAlignment','right','FontSize',15);
text(latitude(7),longitude(7)-0.75,'KOA','HorizontalAlignment','right','FontSize',15);