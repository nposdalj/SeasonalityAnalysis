...
NFC_latLongs = [39.938, - 76;
    ...
    40.195, - 76];
%% HAT
HAT_dates = [datenum([2015 04 07 00 00 00]), datenum([2016 01 21 00 00 00]);
    datenum([2016 04 29 00 00 00]), datenum([2017 02 06 00 00 00]);
    datenum([2017 05 09 00 00 00]), datenum([2017 10 17 00 00 00]);
    datenum([2017 10 25 00 00 00]), datenum([2018 06 01 00 00 00]);
    datenum([2018 06 01 00 00 00]), datenum([2018 12 14 00 00 00]);
    datenum([2018 12 14 00 00 00]), datenum([2019 05 17 18 17 30])];
HAT_depl = [1,2,3,4,5,6];
