...
plotData = readtable('P:\My Drive\WAT_TPWS_metadataReduced\Plots\Manuscript_PlottingData.xlsx');
...
%% Stacked Sites presence per size class
...
for j = 1:3 % Cycle through size classes
    ...
    set(gcf,'units','inches','PaperPositionMode','auto','OuterPosition',[3 0 10 9])
...
%             ylabels_Male = ax_current.YAxis.TickLabels;
%             ylabels_Male(2:2:end) = NaN;
%             ax_current.YAxis.TickLabels = ylabels_Male;
        end
        ax = gca;
...
%         end
    ...
    saveas(gcf, [GDrive ':\My Drive\WAT_TPWS_metadataReduced\Plots\Manuscript_Plots\AllSites_' SaveName 'Presence.png'])
