...
text(latitude(2)-1,longitude(2)+4,'PT','HorizontalAlignment','right','FontSize',16);
text(latitude(3),longitude(3)+5,'QN','HorizontalAlignment','right','FontSize',16);
text(latitude(4),longitude(4)-0.5,'OCNMS','HorizontalAlignment','right','FontSize',16);
text(latitude(5),longitude(5)+5,'BD','HorizontalAlignment','right','FontSize',16);
text(latitude(6),longitude(6)-0.5,'CORC','HorizontalAlignment','right','FontSize',16);
text(latitude(7),longitude(7)-0.5,'GI','HorizontalAlignment','right','FontSize',16);
text(latitude(8),longitude(8)+10,'SAIPAN','HorizontalAlignment','right','FontSize',16);
text(latitude(9),longitude(9)-0.5,'TIN','HorizontalAlignment','right','FontSize',16);
text(latitude(10),longitude(10)-0.5,'Wake','HorizontalAlignment','right','FontSize',16);
