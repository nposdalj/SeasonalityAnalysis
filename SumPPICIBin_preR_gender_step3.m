...
genderFileName = 'Tinian'; %File name to match gender file
...
dayBinCSV= 'G:\My Drive\CentralPac_TPWS_metadataReduced\Tinian\Seasonality\KR_dayData_forGLMR125.csv'; % specify csv document with general PM information
