...
SiteName_forPlots = 'Baja California - Guadalupe Island';
saveDir = ['G:\My Drive\CCE_TPWS_metadataReduced\Baja_GI\Seasonality']; %specify directory to save and load files
%% load workspace
